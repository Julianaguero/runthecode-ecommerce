...
export default function HeroBanner() {
  return (
    <div className="relative flex flex-wrap flex-col-reverse md:flex-row items-center justify-center px-5 md:h-[37rem] max-w-[1560px] mx-auto">
          <div className="flex w-full md:w-[45%] h-full flex-col items-center md:justify-center justify-start pl-6  md:pl-[clamp(1rem,1vw+1rem,2rem)] pt-32 md:pt-4 ">
            <p className="leading-tight text-black font-ginto-nord-regular text-[clamp(35px,4vw+1rem,22rem)]">
            Summer <br />
              <span className="relative font-ginto-nord-regular-italic text-[clamp(35px,4vw+1rem,22rem)] text-back ml-10 after:content-asset1">
                 Collection
              </span> <br />
             2024 
            </p>
